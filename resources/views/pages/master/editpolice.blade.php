               ...
               <div class="form-check form-check-inline police-option {{ $police->category == 'National Police of Timor-Leste (PNTL) Headquarters' ? 'selected' : '' }}">
                ...
                <div class="form-check form-check-inline police-option {{ $police->category == 'Municipal Police' ? 'selected' : '' }}">
                    <input class="form-check-input category-radio"
                        type="radio"
                        name="category"
                        value="Municipal Police"
                        data-icon="{{ asset('images/Layer2.png') }}"
                        {{ $police->category == 'Municipal Police' ? 'checked' : '' }}>
                    <img src="{{ asset('images/Layer2.png') }}" width="16">
                    <label>Municipal Police</label>
                </div>
                ...
                <div class="form-check form-check-inline police-option {{ $police->category == 'Local Police Posts' ? 'selected' : '' }}">
                    <input class="form-check-input category-radio"
                        type="radio"
                        name="category"
                        value="Local Police Posts"
                        data-icon="{{ asset('images/Layer4.png') }}"
                        {{ $police->category == 'Local Police Posts' ? 'checked' : '' }}>
                    <img src="{{ asset('images/Layer4.png') }}" width="16">
                    <label>Local Police Posts</label>
                </div>
        ...
        if (provinceId) {
            $.ajax({
                ...
                success: function (data) {
                    $('#city').empty();
                    $('#city').append('<option value="">-- Choosse Administrative Post --</option>');
