         ...
         <div class="col-md-12">
            <div class="form-group">
                ...
                <select name="city" id="city" class="form-control">
                    <option value="">-Choose Administrative Post-</option>
                </select>
            </div>
        </div>
        ...
        <div class="col-md-12">
         ...
         <div class="col-md-12">
            <div class="form-group">
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input category-radio" type="radio" name="category" value="Municipal Police" data-icon="{{ asset('images/Layer2.png') }}">
                    <img src="{{ asset('images/Layer2.png') }}" style="width:12px; height:12px;">
                    <label class="form-check-label">Municipal Police</label>
                </div>

                <div class="form-check form-check-inline">
                    <input class="form-check-input category-radio" type="radio" name="category" value="Police Station" data-icon="{{ asset('images/Layer3.png') }}">
                    <img src="{{ asset('images/Layer3.png') }}" style="width:12px; height:12px;">
                    <label class="form-check-label">Police Station</label>
                </div>

                <div class="form-check form-check-inline">
                    <input class="form-check-input category-radio" type="radio" name="category" value="Local Police Posts" data-icon="{{ asset('images/Layer4.png') }}">
                    <img src="{{ asset('images/Layer4.png') }}" style="width:12px; height:12px;">
                    <label class="form-check-label">Local Police Posts</label>
                </div>
        ...
        if (provinceId) {
            $.ajax({
                ...
                success: function (data) {
                    $('#city').empty();
                    $('#city').append('<option value="">-- Choose Administrative Post --</option>');
